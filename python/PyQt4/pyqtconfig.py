...
_pkg_config = {
    ...
    'pyqt_config_args':  '-q /usr/local/Trolltech/Qt-4.8.3/bin/qmake',
    'pyqt_mod_dir':      '/usr/lib64/python2.6/site-packages/PyQt4',
    'pyqt_modules':      'QtCore QtGui QtHelp QtMultimedia QtNetwork QtDeclarative QtScript QtScriptTools QtSql QtSvg QtTest QtXml QtXmlPatterns QtDesigner',
    'pyqt_sip_dir':      '/usr/share/sip/PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_X11 -x PyQt_OpenSSL -x PyQt_NoPrintRangeBug -t Qt_4_8_3 -x Py_v3 -g',
    'pyqt_version':      0x040905,
    'pyqt_version_str':  '4.9.5',
    'qt_data_dir':       '/usr/local/Trolltech/Qt-4.8.3',
    'qt_dir':            '/usr/local/Trolltech/Qt-4.8.3',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        '/usr/local/Trolltech/Qt-4.8.3/include',
    'qt_lib_dir':        '/usr/local/Trolltech/Qt-4.8.3/lib',
    'qt_threaded':       1,
    'qt_version':        0x040803,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR_QT':                '/usr/local/Trolltech/Qt-4.8.3/include',
    ...
    'LIBDIR_QT':                '/usr/local/Trolltech/Qt-4.8.3/lib',
    ...
    'MKDIR':                    'mkdir -p',
    'MOC':                      '/usr/local/Trolltech/Qt-4.8.3/bin/moc',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    'strip'
}
